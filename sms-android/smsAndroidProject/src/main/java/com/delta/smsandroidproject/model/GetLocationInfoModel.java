...
public class GetLocationInfoModel implements IModel {

	@Override
	public void loadData(Map<String, String> map,
			Listener<String> responseListener, ErrorListener errorLoginListener) {
		StringCookieRequest request = new StringCookieRequest(Method.GET, String.format(
				Comment.LOCATION_INFO_URL, map.get("key")), responseListener,
				errorLoginListener);
